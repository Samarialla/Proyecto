...
CREATE TABLE `agenda_medica` (
  ...
  KEY `fk_agenda_medica_dias1_idx` (`dias_dias_cod_1`),
  KEY `fk_agenda_medica_especialidades1_idx` (`especialidades_espec_cod_1`),
  CONSTRAINT `fk_agenda_medica_dias1` FOREIGN KEY (`dias_dias_cod_1`) REFERENCES `dias` (`dias_cod_1`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `funcionario` VALUES (1,'sergio','4ea4','44964','4646','4464');
...
INSERT INTO `mercaderia` VALUES (2,'qwq',121,1212,2),(4,'asasD4',4546,4646,2),(5,'sdaasa',446,64,2);
...
CREATE TABLE `pedido` (
  ...
  KEY `fk_pedido_mercaderia1_idx` (`mercaderia_cod_prov`),
  CONSTRAINT `fk_pedido_mercaderia1` FOREIGN KEY (`mercaderia_cod_prov`) REFERENCES `mercaderia` (`cod_prov`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `turno` (
  ...
  PRIMARY KEY (`turno_cod`,`paciente_pac_cod`,`users_id`,`agenda_medica_agend_cod_1`),
  KEY `fk_turno_paciente1_idx` (`paciente_pac_cod`),
  KEY `fk_turno_users1_idx` (`users_id`),
  ...
  CONSTRAINT `fk_turno_users1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (2,'Sergio Javier Amarilla','sergojavier23@gmail.com',NULL,'$2y$10$o9daBtWx6Y3dh993JIeduuuWIia9zJnnjx/WQAHZAeqGKnAsRvU2a',NULL,'2020-06-09 23:52:33','2020-06-09 23:52:33');
...
-- Dump completed on 2020-06-10 10:35:05
